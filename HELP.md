...
* The original package name 'com.devlucasmart.proposta-api' is invalid and this project uses 'com.devlucasmart.propostaapi' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.1.11/reference/htmlsingle/index.html#messaging.websockets)
